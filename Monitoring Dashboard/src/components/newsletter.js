    ...
    >
      <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
        <div className="mx-auto max-w-screen-md sm:text-center">
          ...
          <p className="mx-auto mb-8 max-w-2xl font-light text-black-500 md:mb-12 sm:text-xl dark:text-gray-400">
            Stay up to date with the progress, announcements and notification feel free to sign up with your email.
          </p>
          <form action="#">
            ...
            <div className="mx-auto max-w-screen-sm text-sm text-left text-black-500 newsletter-form-footer dark:text-gray-300">
